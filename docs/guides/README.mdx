...
<Section id="web-sdks" hasSubSections>
  ...
  <Section title="🛡️ Full Nodes & Validators">
    ...
    <Card
      ...
      description="ow the setup of a Full Node on the Akash Network, a decentralized open-source cloud computing platform. By doing so, you promote greater privacy and decentralization compared to using VPS."
