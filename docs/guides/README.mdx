...
<Section id="web-sdks" hasSubSections>
  <Section title="⚙️ Node Setup">
    ...
    <Card
      ...
      description=" How to setup a dVPN node on the Akash Network, a decentralized open-source cloud computing platform. By doing so, you promote greater privacy and decentralization compared to using VPS."
  ...
  <Section title="🛡️ Full Nodes & Validators">
    <Card
      title="Validator Manual Setup"
    ...
    />
    <Card
      title="Full Node via Cloudmos on Akash"
      description="How to setup a Full Node on the Akash Network, a decentralized open-source cloud computing platform. By doing so, you promote greater privacy and decentralization compared to using VPS."
      to="https://github.com/DecloudNodesLab/Projects/blob/main/CosmosSDK/Mainnets/Sentinel/deploy.yml"
      icon={<DvpnAkt />}
      svgFile=""
    />
  </Section>
  <Section title="🖥️ Monitoring & Alerting">
    <Card
      title="Node Monitoring"
      description="An essential guide for monitoring your node: utilizing a variety of tools to collect metrics and ensure readiness in the event of system failures."
      to="/node-monitoring/"
      icon={<SentinelCore />}
      svgFile=""
    />
