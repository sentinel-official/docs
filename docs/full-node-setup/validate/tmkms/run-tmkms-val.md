...
Go to the [Validator page](https://p2pscan.com/validators), select yours and check if it is skipping blocks
...
Go to the [Validator page](https://p2pscan.com/validators), select yours and check if it is signing blocks
