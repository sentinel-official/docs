...
A validator in the [active set](../overview/glossary.md#active-set) participating in consensus. Bonded validators earn rewards.
...
Validators that are not in the [active set](../overview/glossary.md#active-set). These validators do not participate in consensus and do not earn rewards.
