...
### Grpc endpoints
An overview of all available gRPC endpoints shipped with Sentinel are be available in the [Sentinel Protobuf documentation](https://buf.build/sentinel-official/hub). There is also a Cosmos SDK in [Protobuf documentation](https://buf.build/cosmos/cosmos-sdk).
